...
var Swiper = (function () {
  ...
  var A = {
    ...
    updateSlides: function () {
      ...
      for (let i = 0; i < c; i += 1) {
        ...
        if (
          !r ||
          (C && e.grid.updateSlide(i, r, d), "none" !== v(r, "display"))
        ) {
          if (o && "auto" === s.slidesPerView)
            ...
            if (
              ...
              I = e.isHorizontal() ? S(r, "width", !0) : S(r, "height", !0);
            else {
              const e = t(i, "width"),
                s = t(i, "padding-left"),
                n = t(i, "padding-right"),
      ...
      if (
        ((e.virtualSize = Math.max(e.virtualSize, x) + w),
        n &&
          a &&
        ...
        C && e.grid.updateWrapperSize(I, p),
        !s.centeredSlides)
      ) {
        const t = [];
        for (let i = 0; i < p.length; i += 1) {
          ...
          s.roundLengths && (r = Math.floor(r)),
            p[i] <= e.virtualSize - x && t.push(r);
        }
        (p = t),
          Math.floor(e.virtualSize - x) - Math.floor(p[p.length - 1]) > 1 &&
            p.push(e.virtualSize - x);
      }
      if (o && s.loop) {
        const t = m[0] + y;
      ...
      if (
        ...
        u(i, "--swiper-centered-offset-before", -p[0] + "px"),
          u(
            i,
    ...
    updateSlidesProgress: function (e = (this && this.translate) || 0) {
      ...
      for (let e = 0; e < i.length; e += 1) {
        ...
        m && (t.visibleSlides.push(l), t.visibleSlidesIndexes.push(e)),
          C(l, m, s.slideVisibleClass),
          C(l, h, s.slideFullyVisibleClass),
          (l.progress = r ? -c : c),
  ...
  var _ = {
    slideTo: function (e = 0, t, s = !0, i, r) {
      ...
      if (!(T && r) && ((u && -w === n.translate) || (!u && w === n.translate)))
        return (
  ...
  var D = {
    loopCreate: function (e, t) {
      ...
      const o = i.slidesPerGroup * (a ? i.grid.rows : 1),
        ...
        c = (e) => {
          for (let t = 0; t < e; t += 1) {
            const e = s.isElement
              ? g("swiper-slide", [i.slideBlankClass])
              : g("div", [i.slideClass, i.slideBlankClass]);
            s.slidesEl.append(e);
          }
        };
      if (l) {
    ...
    loopFix: function ({
      ...
      if (z < x) {
        ...
        (A = Math.max(z - (P - 2 * x), b)),
          C && (A = Math.max(A, T - P + w + 1));
        for (let e = 0; e < A; e += 1) {
          const t = e - Math.floor(e / P) * P;
          y
            ? d.forEach((e, s) => {
  ...
  class Q {
    constructor(...e) {
      ...
      (n.__swiper__ = !0),
        (n.support = y()),
        (n.device = E({ userAgent: s.userAgent })),
        (n.browser = M()),
        (n.eventsListeners = {}),
